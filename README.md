...
The application requires a connection to a mysql database to exist.  The database connection details are stored with the dbconfig.cf file, located within the Database confguration file
...
Clone the repository to location of choice
